package project.closet.service.feed.basic;
...
import project.closet.service.dto.response.OotdDto;
import project.closet.service.dto.response.UserSummary;
import project.closet.service.dto.response.WeatherSummaryDto;
import project.closet.service.event.FeedCommentCreateEvent;
import project.closet.service.event.FeedCreatedEvent;
import project.closet.service.event.FeedLikeCreateEvent;
import project.closet.service.exception.feed.FeedLikeAlreadyExistsException;
import project.closet.service.exception.feed.FeedNotFoundException;
...
public class BasicFeedService implements FeedService {
    ...
    public void likeFeed(UUID feedId, UUID loginUserId) {
        ...
        eventPublisher.publishEvent(
            new FeedLikeCreateEvent(feed.getAuthor().getId(), loginUser.getName(), feed.getContent()));
